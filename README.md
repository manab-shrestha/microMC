...
Nuclear data files are not included in the repository. The code expects the ENDF/B-VII.1 evaluation procceded to the HDF5 format, which can be downloaded [here](https://anl.box.com/shared/static/9igk353zpy8fn9ttvtrqgzvw1vtejoz6.xz).
