...
with open("k_eigenvalue_tallies.json", "r", encoding="utf-8") as f_json:
...
if selected is None:
    raise ValueError(f"Tally '{tally_name}' not found in k_eigenvalue_tallies.json")
...
print(f"Loaded microMC tally '{tally_name}' from k_eigenvalue_tallies.json")
