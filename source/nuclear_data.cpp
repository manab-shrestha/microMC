...
const char* rxn_type_name(int type) {
    switch (static_cast<RxnType>(type)) {
    case RxnType::ELASTIC:             return "elastic";
    case RxnType::DISCRETE_INELASTIC:  return "disc_inel";
    case RxnType::CONTINUUM_INELASTIC: return "cont_inel";
    case RxnType::FISSION:             return "fission";
    case RxnType::ABSORPTION:          return "absorption";
    case RxnType::N2N:                 return "(n,2n)";
    case RxnType::N3N:                 return "(n,3n)";
    }
    return "unknown";
}
